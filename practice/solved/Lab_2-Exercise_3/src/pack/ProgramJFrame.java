...
class ProgramJFrame extends JFrame {
	...
	public ProgramJFrame() {
		...
		final JLabel title1Label = new JLabel("Select Action"); 
		...
		JComboBox<String> actionDropList = new JComboBox<>(optionsToChoose);
	    
	    // Input
	    final JLabel inputLabel = new JLabel("Input:"); 
	    final JTextField inputTextField = new JTextField(30);
	    
	    // Button
	    final JButton button = new JButton("Execute Action and Print Output");
	    ...
	    button.addActionListener(
		    new InsertButtonActionListener(
		    	actionDropList, inputTextField, outputTextArea));
		...
		addComponent(panel, actionLabel, 		1, 0, 1, 1, 40,  5);
		addComponent(panel, actionDropList, 	1, 1, 1, 1, 60,  5);
		addComponent(panel, inputLabel, 		2, 0, 1, 1, 40,  5);
		addComponent(panel, inputTextField, 	2, 1, 1, 1, 60,  5);				
